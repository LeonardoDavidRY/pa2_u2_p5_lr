...
public class LibroRepositoryImpl implements ILibroRepository {
	...
	public List<Libro> seleccionarPorFechaPublicacion(LocalDateTime fechaPublicacion) {
		...
		// JPQL: SELECT l FROM libro l WHERE l.fechaPublicacion >= :fechaPublicacion
		Query myQuery =this.entityManager.createQuery("SELECT l FROM Libro l WHERE l.fechaPublicacion >= :fechaPublicacion");
